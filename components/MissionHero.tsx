      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
              ...
              <div className="flex items-center gap-0.5 overflow-hidden">
                ...
                <motion.svg
                  ...
                  animate={{
                    ...
                    scale: typingComplete ? [1, 0.92, 1] : 0,
                  }}
                  transition={{
                    duration: 1,
                  ...
                  viewBox="0 0 20 20"
                  aria-hidden="true"
                  className="ml-1 block h-3.5 w-3.5 text-primary relative z-10"
                >
                  <path
                    d="M5.5 10.5C5.5 6.8 8.6 3.8 13.1 3.8c.5 4.5-2.5 7.6-6.2 7.6-.5 0-.9 0-1.4-.1"
                    fill="currentColor"
                    fillOpacity="0.22"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M6 15.8c1.6-2.8 3.5-4.8 6-6.8"
                    stroke="currentColor"
                    strokeWidth="1.3"
                    strokeLinecap="round"
                  />
            ...
            <h2 className="text-[40px] font-normal leading-tight tracking-tight text-black mb-6 font-headings font-bold">
            ...
            <p className="text-lg leading-6 text-black/60 mt-0 mb-6">
              Our mission is to de-stigmatize BPD and provide a comprehensive
              resource hub for patients, families, and researchers.
            </p>
              ...
              <div className="grid grid-cols-12 gap-3 md:gap-5 relative z-10">
                {stats.map((stat, index) => (
                  <div key={index} className="col-span-6 md:col-span-3">
                    ...
                    >
                      <span className="text-xl md:text-2xl font-medium leading-tight tracking-tight text-primary break-words">
                        {stat.value}
                      </span>
