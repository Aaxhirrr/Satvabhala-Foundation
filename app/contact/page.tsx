                        ...
                        <div className="bg-red-50 border border-red-100 p-8 rounded-2xl">
                            ...
                            <ul className="space-y-4">
                                <li className="flex flex-col">
                                    <span className="font-semibold text-foreground">988 Suicide & Crisis Lifeline</span>
                        ...
                        <div className="bg-card border border-border p-8 rounded-2xl">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <a href="mailto:contact@nonprofit.org" className="text-primary hover:underline">contact@nonprofit.org</a>
                                </div>
                                <div className="flex items-center gap-3">
