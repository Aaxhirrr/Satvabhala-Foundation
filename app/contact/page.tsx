                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
                        ...
                        <div className="bg-red-500/10 backdrop-blur-xl border border-red-200/50 p-8 rounded-3xl shadow-[0_8px_32px_0_rgba(220,38,38,0.06)]">
                            <div className="flex items-center gap-3 mb-4 text-red-600">
                                ...
                                <h2 className="text-2xl font-bold font-headings">Immediate Crisis Support</h2>
                            </div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex flex-col">
                                    <span className="font-bold text-foreground font-sans">988 Suicide & Crisis Lifeline</span>
                                    <span className="text-red-600 font-bold text-lg font-sans underline underline-offset-4 decoration-2">Call or Text 988</span>
                                </li>
                                <li className="flex flex-col">
                                    <span className="font-bold text-foreground font-sans">Crisis Text Line</span>
                                    <span className="text-red-600 font-bold text-lg font-sans underline underline-offset-4 decoration-2">Text HOME to 741741</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white/40 backdrop-blur-xl border border-white/50 p-8 rounded-3xl shadow-[0_8px_32px_0_rgba(20,51,28,0.06)]">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <a href="mailto:contact@satvabhala.org" className="text-primary font-bold hover:underline font-sans">contact@satvabhala.org</a>
                                </div>
                                <div className="flex items-center gap-3">
                                    <Phone className="w-5 h-5 text-primary/60" />
                                    <span className="text-foreground/80 font-sans font-medium">+1 (555) 123-4567</span>
                                </div>
                            </div>
                        </div>
                    </div>
