        ...
        <>
            ...
            <main className="pt-32 pb-24 bg-background min-h-screen">
                <div className="mx-auto max-w-4xl px-8">
                    <h1 className="text-[40px] font-normal leading-tight text-[#111A4A] mb-8 text-center">
                        About Us
                    </h1>

                    <div className="prose prose-lg mx-auto text-[#111A4A] opacity-80">
                        <p className="mb-6">
                        ...
                        <h2 className="text-2xl font-medium text-[#156d95] mt-8 mb-4">Our Vision</h2>
                        <p className="mb-6">
                        ...
                        <h2 className="text-2xl font-medium text-[#156d95] mt-8 mb-4">What We Do</h2>
